  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <div>
          <label style={lbl}>Como está sua preparação hoje? <span style={{ color: T.gold }}>*</span></label>
          <select value={f.experiencia} onChange={(e) => set("experiencia", e.target.value)} style={inputS}>
        ...
        <div style={{ maxWidth: 260 }}>
          <label style={lbl}>Quantas horas por semana você consegue estudar?</label>
          <input type="number" inputMode="numeric" min="0" max="168" value={f.disponibilidade}
        ...
        <div>
          <label style={lbl}>Qual matéria mais te preocupa?</label>
          <select value={f.dificuldade} onChange={(e) => set("dificuldade", e.target.value)} style={inputS}>
        ...
        <div>
          <label style={lbl}>Seu objetivo (opcional)</label>
