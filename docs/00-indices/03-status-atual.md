...
|---|---|---|
| Testes | **1052 / 1052 verdes** | medido em 24/09 (Bloco 5 sobre a main com os Blocos 1 a 4) — `bash reset-db.sh && npm test` em Postgres 16 local dedicado (migrations + seed 2×) |
