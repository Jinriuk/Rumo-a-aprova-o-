...
|---|---|---|
| Testes | **974 / 974 verdes** | medido em 24/09 (Bloco 3, pódio vazio, desempate por id, rótulo de Turmas) — `bash reset-db.sh && npm test` em Postgres 16 local dedicado (migrations + seed 2×) |
