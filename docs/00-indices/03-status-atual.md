...
|---|---|---|
| Testes | **989 / 989 verdes** | medido em 24/09 (Bloco 3 sobre a main com o Bloco 1) — `bash reset-db.sh && npm test` em Postgres 16 local dedicado (migrations + seed 2×) |
| Arquivos de teste | **94** (96 `.mjs` em `tests/`) | medido em 24/09 (Bloco 3 sobre a main com o Bloco 1) — `grep -l 'node:test' tests/*.mjs \| wc -l` |
