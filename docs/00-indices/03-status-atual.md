...
|---|---|---|
| Testes | **973 / 973 verdes** | medido em 24/09 (Bloco 3, pódio vazio e desempate por id) — `bash reset-db.sh && npm test` em Postgres 16 local dedicado (migrations + seed 2×) |
