...
-- O valor de cada concurso é gravado pelo seed 13_maturidade_concursos.sql
...
comment on column concursos.maturidade is
  'Maturidade do conteúdo: completa | beta | esqueleto | indisponivel. Fonte única: app/src/modules/conteudo/maturidade.js; gravado pelo seed 13. UI nunca exibe não-completa como pronta.';
